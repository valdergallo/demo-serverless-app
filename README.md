...
```bash
demo-serverless-app$ sam logs -n HelloEfsFunction --stack-name demo-serverless-app --tail
```
...
```bash
demo-serverless-app$ pip install -r tests/requirements.txt --user
# unit test
demo-serverless-app$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
demo-serverless-app$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name demo-serverless-app
```
